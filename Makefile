...
d-dsp:
	GOOS=darwin GOARCH=amd64 $(GC) $(BUILD_EDGE_PAR) -o edge-darwin-amd64 ./bin/edge/main.go

d-dsp-arm64:
	GOOS=darwin GOARCH=arm64 $(GC) $(BUILD_EDGE_PAR) -o edge-darwin-arm64 ./bin/edge/main.go
